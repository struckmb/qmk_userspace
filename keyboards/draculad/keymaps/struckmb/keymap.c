...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_LOWER] = LAYOUT_wrapper(_LOWER_3x5_, KC_MUTE, KC_MUTE, _LOWER_L4_3_, MS_BTN1, SFT_SPC, ATT(KC_BSPC)),
    [LAYER_SYMBL] = LAYOUT_wrapper(_SYMBL_3x5_, KC_MUTE, KC_MUTE, _SYMBL_L4_3_, MS_BTN1, SFT_SPC, KC_RALT),
