...
#ifdef QWERTY_ENABLE
    [LAYER_QWERTY] = LAYOUT_wrapper(_QWERTY_3x5_, KC_MUTE, KC_MUTE, _0L4_3_, KC_BTN1, _0R4_2R),
    #endif // ifdef QWERTY_ENABLE
#ifdef NOTED_ENABLE
    [LAYER_NOTED] = LAYOUT_wrapper(_NOTED_3x5_, KC_MUTE, KC_MUTE, _0L4_3_, KC_BTN1, _0R4_2R),
    #endif // ifdef NOTED_ENABLE
#ifdef BONE_ENABLE
    [LAYER_BONE] = LAYOUT_wrapper(_BONE_3x5_, KC_MUTE, KC_MUTE, _0L4_3_, KC_BTN1, _0R4_2R),
    #endif // ifdef BONE_ENABLE
#ifdef COLEMAK_DH_ENABLE
    [LAYER_COLEMAK_DH] = LAYOUT_wrapper(_COLEMAK_DH_3x5_, KC_MUTE, KC_MUTE, _0L4_3_, KC_BTN1, _0R4_2R),
    #endif /* ifdef COLEMAK_DH_ENABLE */
#ifdef MAC_LAYER_ENABLE
    [LAYER_MC_THUMBS] = LAYOUT_wrapper(_3x5_TRNS_, KC_MUTE, KC_MUTE, _THUMBS_L3_MAC, KC_BTN1, _THUMBS_2R_MAC),
    #endif /* ifdef COLEMAK_DH_ENABLE */

    [LAYER_SYMBL] = LAYOUT_wrapper(_SYMBL_3x5_, KC_MUTE, KC_MUTE, _SYMBL_L4_3_, KC_BTN1, SFT_SPC, KC_RALT),
    [LAYER_LOWER] = LAYOUT_wrapper(_LOWER_3x5_, KC_MUTE, KC_MUTE,_LOWER_L4_3_, KC_BTN1, SFT_SPC, ATT(KC_BSPC)),
    [LAYER_RAISE] = LAYOUT_wrapper(_RAISE_3x5_, KC_MUTE, KC_MUTE, _RAISE_L4_3_, KC_BTN1, RSFT_T(KC_VOLU), KC_TRNS),
#ifdef MAC_LAYER_ENABLE
    [LAYER_MC_RAISE] = LAYOUT_wrapper(_RAISE_3x5_MAC, KC_MUTE, KC_MUTE, _RAISE_L4_3_, KC_BTN1, RSFT_T(KC_VOLU), KC_TRNS),
    #endif /* ifdef COLEMAK_DH_ENABLE */
    [LAYER_ATTIC] = LAYOUT_wrapper(_ATTIC_3x5_, KC_MUTE, KC_MUTE, _ATTIC_L4_3_, KC_BTN1, RSFT_T(KC_BRIU), KC_TRNS),
};
